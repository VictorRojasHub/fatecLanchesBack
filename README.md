...
Código-fonte do front-end disponível em: [Lizandraferrari/fatec-lanches](https://github.com/Lizandraferrari/fatec-lanches)
...
### 🚀 Instalação
  ```bash
   git clone https://github.com/VictorRojasHub/fatecLanchesBack.git
   ```
  ```bash
   npm install
   ```
